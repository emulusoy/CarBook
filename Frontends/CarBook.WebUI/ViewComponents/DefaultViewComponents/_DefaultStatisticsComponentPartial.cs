...
namespace CarBook.WebUI.ViewComponents.DefaultViewComponents
{
    public class _DefaultStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("https://localhost:7028/api/Statistics/GetCarCountByFuelElectric");
            ...
            return View("/Views/Shared/Components/DefaultComponents/_DefaultStatisticsComponentPartial/Default.cshtml");
        }
    }
}
