    ...
    public class _ServiceViewComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                return View("/Views/Shared/Components/ServiceComponents/_ServiceViewComponentPartial/Default.cshtml", values);
            }
            return View("/Views/Shared/Components/ServiceComponents/_ServiceViewComponentPartial/Default.cshtml");
        }
    }
}
