...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(CreateCategoryCommandHandler createCategoryCommandHandler, UpdateCategoryCommandHandler updateCategoryCommandHandler, GetCategoryByIdQueryHandler getCategoryByIdQueryHandler, GetCategoryQueryHandler getCategoryQueryHandler, RemoveCategoryCommandHandler removeCategoryCommandHandler)
        {
        ...
        public async Task<IActionResult> CreateCategory(CreateCategoryCommand command)
        {
            ...
            return Ok("New Category information added ");
        }
        [HttpDelete]
