...
namespace CarBook.WebApi.Controllers
{
    ...
    public class FooterAddressController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateFooterAddress(CreateFooterAddressCommand command)
        {
            ...
            return Ok("FooterAddress paramaters added succesfuly");
        }
        [HttpDelete]
        public async Task<IActionResult> RemoveFooterAddress(int id)
        {
            await _mediator.Send(new RemoveFooterAddressCommand(id));
            return Ok("FooterAddress paramaters deleted succesfuly");
        }
        [HttpPut]
        public async Task<IActionResult> UpdateFooterAddress(UpdateFooterAddressCommand command)
        {
            await _mediator.Send(command);
            return Ok("FooterAddress paramaters updated succesfuly");
        }
    }
}
